...
// 		this.ompHost = "http://test.peemail.org";  // for testing
	...
	ompLoadURI: function(uri) {
		if(uri.scheme == "file") {
			...
			gBrowser.loadURI(this.ompFileURL, uri, null, null);
...
// 			this.Ci.nsIFileInputStream.CLOSE_ON_EOF);
		...
		nsIFileInputStream.init(nsIFile_file, 0x01, 00004, null);
...
// 		this.alertInputStream(postData);
		...
		var refuri = this.ioService.newURI(this.ompURL, null, null);
